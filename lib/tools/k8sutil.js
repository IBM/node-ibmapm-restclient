...
K8sutil.prototype.fetchK8MProviderID = function(callback) {
    ...
    var endpoint = 'https://' + process.env.KUBERNETES_SERVICE_HOST +
        ':' + process.env.KUBERNETES_SERVICE_PORT + '/api/v1/namespaces/' +
        this.getNamespace() + '/configmaps/ibm-k8monitor-config';
    var header = {
    ...
    req.on('data', function(data){
        logger.warn('k8sutil', 'fetchK8MProviderID data', data.toString());
    });
    req.end();
    return nodeArray;
};
