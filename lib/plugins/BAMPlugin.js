...
module.exports.send = function(tasks) {
    ...
    var curr = new Date();
    if (!global.META_ISSEND && curr - metadataUploadTimestamp > 1800000) {
        metadataUploadTimestamp = curr;
        sendMetadata();
    }
    if (!global.UI_ISSEND && curr - uiUploadTimestamp > 1800000) {
...
function sendMetadata() {
    ...
    try {
        ...
        let mdruntime =
            require('../../etc/ResourceTypes/nodeApplicationRuntime_1.4_ResourceType.json');
